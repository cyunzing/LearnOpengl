...
int main(int argc, char *argv[])
{
    ...
    GLFWwindow *window = glfwCreateWindow(WINDOW_SIZE, WINDOW_SIZE, "Directional light", NULL, NULL);
    if (!window)
        return -1;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniform3f(glGetUniformLocation(shader.programId, "light.direction"), lampDirection.x, lampDirection.y, lampDirection.z);
